                    ...
                    <!-- end search -->
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{$data->detail}}</td>
                                <td>
                                <img src="{{$data->p_image}}" height="100" width="100"/>
                                </td>
                                <td>
                                <!-- <a href="deletepsot/{{$data->id}}"  class="btn btn-danger"  >حذف</a> -->
                                
<a class="btn btn-danger" onclick="return confirm('آیا میخواهید حذف کنید؟')" href="post_delete/{{$data->p_id}}"><i class="fa fa-trash"></i></a>
</td>
<td>
                                <!-- <a href="deletepsot/{{$data->id}}"  class="btn btn-danger"  >حذف</a> -->
